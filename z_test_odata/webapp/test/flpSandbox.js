		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "test odata",
									"targetURL": "#comeneryaztestodata-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comeneryaztestodata-display": {
								"semanticObject": "comeneryaztestodata",
								"action": "display",
								"description": "test o data",
								"title": "test odata",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.enerya.ztestodata",
									"url": sap.ui.require.toUrl("com/enerya/ztestodata")
								}
							}
						}
					}
